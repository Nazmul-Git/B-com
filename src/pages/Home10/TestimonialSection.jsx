...
import arrow4 from '../../assets/images/testimonial/style2/arrow-4.png';
...
const TestimonialSection = ({ previewPhone, previewPhoneExt, previewSM, previewMd, preview, showPagination }) => {
    ...
    return (
        <div className="rs-testimonial testimonial-style3 pt-125 pb-180 md-pt-80 md-pb-130">
            <div className="container">
                ...
                <div className="slider testi-slide-3">
