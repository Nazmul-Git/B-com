...
import quotationMark from '../../assets/images/testimonial/style1/quotation-mark2.png';
...
const TestimonialSection = ({ previewPhone, previewPhoneExt, previewSM, previewMd, preview, showPagination }) => {
    ...
    return (
        <div className="rs-testimonial testimonial-style4 testimonial-modify6 bg40 pt-140 pb-210 md-pt-70 md-pb-40">
            <div className="container">
                <div className="sec-title text-center mb-50">
                    <h2 className="title white-color">
                        What’s client says about<br />our company
                    </h2>
                </div>
