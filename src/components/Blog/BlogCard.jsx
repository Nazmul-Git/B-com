        ...
        <div className="blog-item">
            <div className="blog-inner-wrap">
                <div className="image-wrap">
                    <Link to={`${blogUrl ? blogUrl : '/blog-single'}`}>
                        <img src={blog.imgSrc} alt="Images" />
                    </Link>
                    {
                        topButton &&
                        <div class="pre-cat-list">
                            <Link to={`${blogUrl ? blogUrl : '/blog-single'}`}>Consulting</Link>
                        </div>
                    }
                </div>
                <div className="blog-content">
                    <ul className={`${contentClass ? contentClass : 'pre-blog-meta'}`}>
                        ...
                        <li className={listClass2 ? listClass2 : ''}><i className="ri-user-line"></i><Link to={`${blogUrl ? blogUrl : '/blog-single'}`}>{blog.author}</Link></li>
                    </ul>
                    <h5 className="blog-title">
                        <Link to={`${blogUrl ? blogUrl : '/blog-single'}`}>{blog.title}</Link>
                    </h5>
                    {
                        blogDesc &&
