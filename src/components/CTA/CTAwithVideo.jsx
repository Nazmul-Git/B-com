...
const CTAwithVideo = ({ arrowImg, ctaBgVideo, ctaStyleClass, otherClass,iconClass }) => {
    return (
        <div className={`rs-cta cta-main-home ${ctaStyleClass ? ctaStyleClass : ''} ${otherClass ? otherClass : 'pt-80 pb-80'} `}>
                ...
                <div className="row y-middle">
                    ...
                    <div className="col-lg-5 text-right md-left">
                        <div className="bnr-part">
                            <Link className={`readon started phone-number ${iconClass ? iconClass : 'phone-small'}`} to="/contact-us-1">
